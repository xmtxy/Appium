...
class YamlUtil:
    ...
    def read_yaml(self, key):
        ...
        with open(os.getcwd()+"/extract.yaml", encoding="utf-8") as file:  #  默认的就是mode="r",可不写
    ...
    def clear_yaml(self):
        with open(os.getcwd() + "/extract.yaml", encoding="utf-8", mode="w") as file:
            file.truncate()  # 扯 k特
    # 注意点:
    # 在yaml_util中运行则,工作路径是 D:\PythonPc_App\Appium基础\common
    # 如果实在根节点中运行则工作路径是 D:\PythonPc_App\Appium基础
    ...
    #     with open(os.getcwd() + '\\bzx_test_case\\' + yaml_name, mode='r', encoding='utf-8') as f:
...
# YamlUtil().read_yaml("token") #D:\PythonPc_App\Appium基础\common