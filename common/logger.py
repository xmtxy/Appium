...
class GetLogger:
    ...
    def get_logger(cls):
        if cls.logger is None:
            # 创建日志器,控制他的创建次数
            cls.logger = logging.getLogger('xM_Appium_UI_Test')  # 这里的值是自定义的
            ...
            # print(os.path.abspath(__file__)) #D:\PythonPc_App\Appium\common\logger.py
            # print(project_path) #D:\PythonPc_App\Appium\
            # 3.创建处理器 按照时间进行切割文件
